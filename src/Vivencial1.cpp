...
int main()
{
    ...
    objects.push_back({glm::vec3(-3.5f, 0.0f, 0.0f), glm::vec3(0), 1.0f});
    objects.push_back({glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0), 1.0f});
    objects.push_back({glm::vec3(3.5f, 0.0f, 0.0f), glm::vec3(0), 1.0f});

    int nVertices;
    GLuint objVAO = loadSimpleOBJ("../src/3DModels/Suzanne.obj", nVertices);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 view = glm::translate(
            glm::mat4(1.0f),
            glm::vec3(0.0f, 0.0f, -8.0f) // "afasta" a câmera
        );
